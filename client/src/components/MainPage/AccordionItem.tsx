        ...
        <>
          <Disclosure.Button
            className={`${open ? "shadow-white/75 shadow-md" : "hover:shadow-purpleFirst/75 hover:shadow-md"}
              flex w-full justify-between rounded-lg p-6 text-left text-base transition-shadow font-medium text-gray-50
          ...
          >
            ...
            <ChevronIcon
              ...
              } h-5 w-5 stroke-gray-50 transition-transform`}
            />
          </Disclosure.Button>
          <Transition
            show={open}
          ...
          >
            <Disclosure.Panel
              className={`px-6 pb-5 pt-4 text-sm+ text-secondary`}
              static
            >
              {description}
            </Disclosure.Panel>
