...
const Card = ({ iconComponent, title, description }: CardProps) => {
  return (
    <div className="flex items-center p-6 mb-10 box-border text-center w-full sm:w-[calc(33.333%-2em)] flex-col text-secondary bg-bgSecondary shadow-lg border-0 rounded-lg">
