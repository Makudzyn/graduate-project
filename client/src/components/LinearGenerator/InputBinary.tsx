...
const InputBinary = ({
  ...
  return (
    <div className="pt-2 pb-5 font-medium text-gray-900 leading-6">
      <label htmlFor="binary-input" className="block h-6 text-lg">
        {inputLabel}
      </label>
      <div className="relative">
        ...
        />
        <span
          className={`${color === 'red' ? 'text-red-500' : 'text-green-500'} absolute select-none flex justify-center items-center right-0 top-0 bottom-0 px-[1.75em] text-xs font-semibold opacity-50`}
        >
