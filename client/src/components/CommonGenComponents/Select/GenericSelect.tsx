      ...
      {({ open }) => (
        <>
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative w-full cursor-pointer rounded-md bg-white text-sm+ pr-10 pl-3 text-left text-paragraph shadow-md ring-1 ring-inset ring-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm+ sm:leading-6">
